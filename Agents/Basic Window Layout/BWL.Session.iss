...
objectdef bwlSession
{
    ...
    variable bwlHorizontalRRLayout HorizontalRRLayout
    ...
    method UpdateCurrentLayout()
    {
        switch ${Settings.UseLayout}
        {
            ...
            case Horizontal
                ...
                break
            case HorizontalRR
                CurrentLayout:SetReference["HorizontalRRLayout"]
                break
            case Vertical
    ...
    method HorizontalRRApply()
    {
        variable string rr="HorizontalRR"
        
        ; if ${Settings.UseLayout~}==${rr}
        ;     return
        BWLSession.HorizontalRRLayout:ApplyWindowLayout
]
]    
    }
